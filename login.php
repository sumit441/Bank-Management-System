...
<body style="background: url(images/bg-login3s.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Sumit Tamang</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	...
       	<input type="password" name="password" value="tupilato123" class="form-control" required placeholder="Enter Password">
